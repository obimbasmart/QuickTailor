...
USER_SIDEBAR_LINKS = [
    ...
    {"name": "how it works", "link": "app_views.how_it_works",
        "is_protected": 0, "icon_name": "howitworks"},
...
ADMIN_SIDEBAR_LINKS = [
    ...
    {"name": "dashboard", "link": "tailor_views.dashboard",
        "is_protected": 0, "icon_name": "products"},
    {"name": "my products", "link": 'tailor_views.get_all_products',
        "is_protected": 0, "icon_name": "products"},
    {"name": "orders", "link": "app_views.orders",
        "is_protected": 0, "icon_name": "orders"},
    {"name": "notifications", "link": "tailor_views.dashboard",
        "is_protected": 0, "icon_name": "notifications"},
    {"name": "messages", "link": "tailor_views.get_all_products",
...
Login_fields = [
    {"label": "Email", "placeholder": "example@gmail.com",
        "type": "email", "id": "name_id"},
    {"label": "Password", "placeholder": "password",
     "type": "password", "id": "password_id"},
...
Reset_fields = [
    ...
    {"label": "Confirm_password", "placeholder": "Confirm Password",
...
Create_user_fields = [
    ...
    {"label": "Name", "placeholder": "Okereke Uzochukwu",
        "type": "name_id", "id": "name_id"},
    {"label": "Email", "placeholder": "example@gmail.com",
     "type": "email", "id": "email_id"},
    {"label": "Phone_number", "placeholder": "07033734183",
     "type": "number", "id": "phone_id"},
    {"label": "Password", "placeholder": "password",
     "type": "password", "id": "password_id"}
...
Tailor_address_fields = [
    ...
    {"label": "Street", "placeholder": "#1 Danosa Street, Benin auchi road",
        "type": "text", "id": "street_id"},
    {"label": "City", "placeholder": "Benin City",
     "type": "text", "id": "city_id"},
...
Tailor_verification_fields = [
    ...
    {"label": "Upload_NIN_Slip", "placeholder": "Benin City",
     "type": "file", "id": "nin_slip"},
    {"label": "Upload_your_photo", "placeholder": "Edo",
     "type": "file", "id": "photo_id"}
